...
const Projects = () => {
  ...
  const projects = [
    ...
    { img: "", alt: "", title: "User API Postgres", href: "https://github.com/zarref-semog/node-postgresql", description: "API for manage users using ExpressJS and PostgreSQL.", technologies: [NodeJS, Postgres, API] },
